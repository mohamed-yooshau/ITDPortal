    ...
    <section className="card">
      ...
      <div className="panel">
        ...
        <form className="form" onSubmit={handleSave}>
          <label>
            DB User
            <input value={form.dbUser} onChange={(event) => setForm({ ...form, dbUser: event.target.value })} />
          </label>
          <label>
            DB Password
          ...
          <label>
            DB Name
            <input value={form.dbName} onChange={(event) => setForm({ ...form, dbName: event.target.value })} />
          </label>
          <label>
            DB Host
            <input value={form.dbHost} onChange={(event) => setForm({ ...form, dbHost: event.target.value })} />
          </label>
          <label>
            DB Port
            <input value={form.dbPort} onChange={(event) => setForm({ ...form, dbPort: event.target.value })} />
          </label>
